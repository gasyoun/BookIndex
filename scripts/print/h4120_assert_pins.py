...
EXPECTED = {
    "Кольский полуостров": (247.00, 195.00),
    "Финляндия": (240.00, 265.00),
    "Архангельская": (330.00, 227.00),
    "Британия · Англия": (200.00, 165.00),
    "Средняя Азия": (441.00, 396.00),
    "Европа": (85.00, 196.00),
...
def main():
    ...
    for s in sheets:
        ...
        accepted = {"Литовское княжество", "Малая Азия", "Британские острова", "Ирак", "Венеция"}

...
2. [DONE] **v7.2: Comparative Timelines** - Overlaying linguistic shifts with historical world events.
3. [DONE] **v7.3: Semantic Search v2** - Advanced natural language query handling across the corpus.

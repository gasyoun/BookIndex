...
3. Добавить quality queue JSON из `scripts/content_report.py`.
4. Показать actionable queues в corpus/source quality UI.
5. Разобрать 1 duplicate-head group и 22 sort inversions.
6. Начать рост контекстного покрытия с `lexicon` и `subject_index`.

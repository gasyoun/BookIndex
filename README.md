...
Текущая редакторская очередь: 23 suspicious heads, 0 sort inversions, 0 duplicate-head groups. Из manual audit найдено 11 из 11 терминов; без точного `head` сейчас не остаётся терминов.

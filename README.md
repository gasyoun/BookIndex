...
Текущая редакторская очередь: 23 suspicious heads (23 помечены `needs_review`, 0 без triage), 22 sort inversions, 1 duplicate-head group. Из manual audit найдено 11 из 11 терминов; без точного `head` сейчас не остаётся терминов.
...
6. Добавить cross-book duplicate candidates в quality queue.

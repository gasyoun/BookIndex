...
Provenance/license: © OpenAI, plugins repo carries NO LICENSE file (checked 2026-09-05); reference-only internal use, verbatim copy with attribution. Do not redistribute.
-->

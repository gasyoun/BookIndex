var BookIndex = (function(exports) {
	...
	//#endregion
	//#region src/runtime/core/state.js
	var state_exports = /* @__PURE__ */ __exportAll({
		AGGREGATE_CACHE_MAX: () => 100,
		APP_BUILD_ID: () => APP_BUILD_ID$1,
		APP_DATA: () => APP_DATA$1,
		APP_DATA_GLOBAL_FALLBACK_KEY: () => APP_DATA_GLOBAL_FALLBACK_KEY$1,
		APP_DATA_MODULES_BASE_URL: () => APP_DATA_MODULES_BASE_URL$1,
		APP_DATA_SCHEMA_CURRENT: () => 2,
		APP_DATA_SCRIPT_TAG_ID: () => APP_DATA_SCRIPT_TAG_ID$1,
		CHAPTER_ITEM_INDEX: () => CHAPTER_ITEM_INDEX$1,
		COLORS: () => COLORS$1,
		DEFAULT_TOTAL_PAGES: () => 424,
		ENTITY_TYPES: () => ENTITY_TYPES$1,
		EPOCH_COLORS: () => EPOCH_COLORS$1,
		EPOCH_LABELS: () => EPOCH_LABELS$1,
		FAMILY_COLORS: () => FAMILY_COLORS$1,
		HASH_ROUTE_PREFIX: () => "v4",
		ITEM_HASH_HEAD_BY_SLUG: () => ITEM_HASH_HEAD_BY_SLUG$1,
		ITEM_HASH_SLUG_BY_HEAD: () => ITEM_HASH_SLUG_BY_HEAD$1,
		ITEM_INDEX_EXACT: () => ITEM_INDEX_EXACT$1,
		ITEM_INDEX_NORMALIZED: () => ITEM_INDEX_NORMALIZED$1,
		KWIC_MAX_ROWS: () => KWIC_MAX_ROWS$1,
		KWIC_MAX_SNIPPETS_PER_PAGE: () => 24,
		KWIC_MAX_SNIPPET_LENGTH: () => 420,
		LABELS: () => LABELS$1,
		MAX_GLOBAL_QUERY_LENGTH: () => 100,
		MAX_HASH_PARTS: () => 16,
		MAX_HASH_PART_LENGTH: () => 120,
		MAX_HASH_SLUG_LENGTH: () => 60,
		MAX_LIST_QUERY_LENGTH: () => 100,
		NORMALIZE_CACHE_LIMIT: () => NORMALIZE_CACHE_LIMIT$1,
		PAGE_TO_CHAPTER: () => PAGE_TO_CHAPTER$1,
		activeFilters: () => activeFilters$1,
		aggregateCache: () => aggregateCache$1,
		currentEntity: () => currentEntity$1,
		currentGlossaryTerm: () => currentGlossaryTerm$1,
		currentKwicPageEnd: () => currentKwicPageEnd$1,
		currentKwicPageStart: () => currentKwicPageStart$1,
		currentKwicQuery: () => currentKwicQuery$1,
		currentKwicSort: () => currentKwicSort$1,
		currentKwicSource: () => currentKwicSource$1,
		currentLecture: () => currentLecture$1,
		currentScholarAnchor: () => currentScholarAnchor$1,
		currentTab: () => currentTab$1,
		currentVizModule: () => currentVizModule$1,
		currentVizQueryString: () => currentVizQueryString$1,
		expectedHash: () => expectedHash$1,
		familiesGraphLayoutPromiseCache: () => familiesGraphLayoutPromiseCache$1,
		getCurrentGlossaryTerm: () => getCurrentGlossaryTerm,
		getCurrentKwicPageEnd: () => getCurrentKwicPageEnd,
		getCurrentKwicPageStart: () => getCurrentKwicPageStart,
		getCurrentKwicQuery: () => getCurrentKwicQuery,
		getCurrentKwicSort: () => getCurrentKwicSort,
		getCurrentKwicSource: () => getCurrentKwicSource,
		getCurrentScholarAnchor: () => getCurrentScholarAnchor,
		getCurrentVizModule: () => getCurrentVizModule,
		getCurrentVizQueryString: () => getCurrentVizQueryString,
		getPendingGlossaryQuery: () => getPendingGlossaryQuery,
		getPendingKwicTerm: () => getPendingKwicTerm,
		getPendingScholarAnchor: () => getPendingScholarAnchor,
		globalSearchActiveIndex: () => globalSearchActiveIndex$1,
		globalSearchScope: () => globalSearchScope$1,
		globalSearchTimer: () => globalSearchTimer$1,
		graphStrongOnly: () => graphStrongOnly$1,
		historyStack: () => historyStack$1,
		isNavigatingHistory: () => isNavigatingHistory$1,
		lectureCompareA: () => lectureCompareA$1,
		lectureCompareB: () => lectureCompareB$1,
		nameGraphLayoutPromiseCache: () => nameGraphLayoutPromiseCache$1,
		nameGraphMinEdgeWeight: () => nameGraphMinEdgeWeight$1,
		normalizeHeadCache: () => normalizeHeadCache$1,
		onlyDiscussed: () => onlyDiscussed$1,
		onlyQuestionCandidates: () => onlyQuestionCandidates$1,
		pendingGlossaryQuery: () => pendingGlossaryQuery$1,
		pendingKwicTerm: () => pendingKwicTerm$1,
		pendingScholarAnchor: () => pendingScholarAnchor$1,
		...
		setChapterItemIndex: () => setChapterItemIndex,
		setColors: () => setColors,
		setCurrentEntity: () => setCurrentEntity,
		setCurrentGlossaryTerm: () => setCurrentGlossaryTerm,
		setCurrentKwicPageEnd: () => setCurrentKwicPageEnd,
		setCurrentKwicPageStart: () => setCurrentKwicPageStart,
		setCurrentKwicQuery: () => setCurrentKwicQuery,
		setCurrentKwicSort: () => setCurrentKwicSort,
		setCurrentKwicSource: () => setCurrentKwicSource,
		setCurrentLecture: () => setCurrentLecture,
		setCurrentScholarAnchor: () => setCurrentScholarAnchor,
		setCurrentTab: () => setCurrentTab,
		setCurrentVizModule: () => setCurrentVizModule,
		setCurrentVizQueryString: () => setCurrentVizQueryString,
		setEntityTypes: () => setEntityTypes,
		setEpochColors: () => setEpochColors,
		setEpochLabels: () => setEpochLabels,
		setExpectedHash: () => setExpectedHash,
		setFamilyColors: () => setFamilyColors,
		setGlobalSearchActiveIndex: () => setGlobalSearchActiveIndex,
		setGlobalSearchScope: () => setGlobalSearchScope,
		setGlobalSearchTimer: () => setGlobalSearchTimer,
		setGraphStrongOnly: () => setGraphStrongOnly,
		setHistoryStack: () => setHistoryStack,
		setIsNavigatingHistory: () => setIsNavigatingHistory,
		setItemHashHeadBySlug: () => setItemHashHeadBySlug,
		setItemHashSlugByHead: () => setItemHashSlugByHead,
		setItemIndexExact: () => setItemIndexExact,
		setItemIndexNormalized: () => setItemIndexNormalized,
		setLabels: () => setLabels,
		setLectureCompareA: () => setLectureCompareA,
		setLectureCompareB: () => setLectureCompareB,
		setNameGraphMinEdgeWeight: () => setNameGraphMinEdgeWeight,
		setOnlyDiscussed: () => setOnlyDiscussed,
		setOnlyQuestionCandidates: () => setOnlyQuestionCandidates,
		setPageToChapter: () => setPageToChapter,
		setPendingGlossaryQuery: () => setPendingGlossaryQuery,
		setPendingKwicTerm: () => setPendingKwicTerm,
		setPendingScholarAnchor: () => setPendingScholarAnchor,
		setRightPaneMode: () => setRightPaneMode,
		setSearchQuery: () => setSearchQuery,
		setSelectedItem: () => setSelectedItem,
		setSelectedItemType: () => setSelectedItemType,
		setSortMostFrequentFirst: () => setSortMostFrequentFirst,
		setSuppressHashSync: () => setSuppressHashSync,
		setTrendsRangeEnd: () => setTrendsRangeEnd,
		setTrendsRangeStart: () => setTrendsRangeStart,
		sortMostFrequentFirst: () => sortMostFrequentFirst$1,
		suppressHashSync: () => suppressHashSync$1,
		syncStateFromGlobal: () => syncStateFromGlobal,
		syncStateToGlobal: () => syncStateToGlobal,
		trendsRangeEnd: () => trendsRangeEnd$1,
		trendsRangeStart: () => trendsRangeStart$1
	});
	var APP_DATA_SCRIPT_TAG_ID$1 = "app-data-json";
	var APP_DATA_GLOBAL_FALLBACK_KEY$1 = "__APP_DATA_STRING__";
	var APP_DATA_MODULES_BASE_URL$1 = "./data/modules/";
	var KWIC_MAX_ROWS$1 = 1200;
	var APP_BUILD_ID$1 = "__APP_BUILD_ID__";
	var NORMALIZE_CACHE_LIMIT$1 = 5e3;
	var APP_DATA$1 = null;
	var LABELS$1 = null;
	var COLORS$1 = null;
	var EPOCH_LABELS$1 = null;
	var EPOCH_COLORS$1 = null;
	var FAMILY_COLORS$1 = null;
	var ENTITY_TYPES$1 = null;
	var ITEM_INDEX_EXACT$1 = /* @__PURE__ */ new Map();
	var ITEM_INDEX_NORMALIZED$1 = /* @__PURE__ */ new Map();
	var CHAPTER_ITEM_INDEX$1 = /* @__PURE__ */ new Map();
	var ITEM_HASH_SLUG_BY_HEAD$1 = /* @__PURE__ */ new Map();
	var ITEM_HASH_HEAD_BY_SLUG$1 = /* @__PURE__ */ new Map();
	var PAGE_TO_CHAPTER$1 = /* @__PURE__ */ new Map();
	var currentEntity$1 = "home";
	var currentTab$1 = "home";
	var activeFilters$1 = /* @__PURE__ */ new Set();
	var onlyDiscussed$1 = false;
	var onlyQuestionCandidates$1 = false;
	var searchQuery$1 = "";
	var sortMostFrequentFirst$1 = false;
	var selectedItem$1 = null;
	var selectedItemType$1 = null;
	var rightPaneMode$1 = "histogram";
	...
	var trendsRangeEnd$1 = 424;
	var historyStack$1 = [];
	var isNavigatingHistory$1 = false;
	var suppressHashSync$1 = false;
	var expectedHash$1 = null;
	var globalSearchTimer$1 = null;
	var globalSearchActiveIndex$1 = -1;
	var globalSearchScope$1 = "corpus";
	var pendingGlossaryQuery$1 = "";
	var currentSimRootIndex$1 = 0;
	var currentSimStep$1 = 0;
	var currentAccentReconRootIndex$1 = 0;
	var currentAccentReconStageIndex$1 = 0;
	var currentOrthoHydratorInput$1 = "хлеб";
	...
	var getPendingGlossaryQuery = () => pendingGlossaryQuery$1;
	var setPendingGlossaryQuery = (v) => {
		pendingGlossaryQuery$1 = v;
	};
	var currentGlossaryTerm$1 = "";
	var getCurrentGlossaryTerm = () => currentGlossaryTerm$1;
	var setCurrentGlossaryTerm = (v) => {
		currentGlossaryTerm$1 = v;
	};
	var pendingScholarAnchor$1 = "";
	var getPendingScholarAnchor = () => pendingScholarAnchor$1;
	var setPendingScholarAnchor = (v) => {
		pendingScholarAnchor$1 = v;
	};
	var currentScholarAnchor$1 = "";
	var getCurrentScholarAnchor = () => currentScholarAnchor$1;
	var setCurrentScholarAnchor = (v) => {
		currentScholarAnchor$1 = v;
	};
	var currentVizModule$1 = "viz03";
	var getCurrentVizModule = () => currentVizModule$1;
	var setCurrentVizModule = (v) => {
		currentVizModule$1 = v;
	};
	var currentVizQueryString$1 = "";
	var getCurrentVizQueryString = () => currentVizQueryString$1;
	var setCurrentVizQueryString = (v) => {
		currentVizQueryString$1 = v;
	};
	var currentKwicSource$1 = "lexicon";
	var getCurrentKwicSource = () => currentKwicSource$1;
	var setCurrentKwicSource = (v) => {
		currentKwicSource$1 = v;
	};
	var currentKwicQuery$1 = "";
	var getCurrentKwicQuery = () => currentKwicQuery$1;
	var setCurrentKwicQuery = (v) => {
		currentKwicQuery$1 = v;
	};
	var currentKwicSort$1 = "left";
	var getCurrentKwicSort = () => currentKwicSort$1;
	var setCurrentKwicSort = (v) => {
		currentKwicSort$1 = v;
	};
	var currentKwicPageStart$1 = 1;
	var getCurrentKwicPageStart = () => currentKwicPageStart$1;
	var setCurrentKwicPageStart = (v) => {
		currentKwicPageStart$1 = v;
	};
	var currentKwicPageEnd$1 = 424;
	var getCurrentKwicPageEnd = () => currentKwicPageEnd$1;
	var setCurrentKwicPageEnd = (v) => {
		currentKwicPageEnd$1 = v;
	};
	var pendingKwicTerm$1 = "";
	var getPendingKwicTerm = () => pendingKwicTerm$1;
	var setPendingKwicTerm = (v) => {
		pendingKwicTerm$1 = v;
	};
	var normalizeHeadCache$1 = /* @__PURE__ */ new Map();
	var aggregateCache$1 = /* @__PURE__ */ new Map();
	var nameGraphLayoutPromiseCache$1 = /* @__PURE__ */ new Map();
	var familiesGraphLayoutPromiseCache$1 = /* @__PURE__ */ new Map();
	function setAppData(val) {
		APP_DATA$1 = val;
	...
	function setOnlyDiscussed(val) {
		onlyDiscussed$1 = val;
		if (typeof window !== "undefined") window.onlyDiscussed = val;
	}
	function setOnlyQuestionCandidates(val) {
		onlyQuestionCandidates$1 = val;
	...
	function setSortMostFrequentFirst(val) {
		sortMostFrequentFirst$1 = val;
	...
	function setSelectedItemType(val) {
		selectedItemType$1 = val;
	...
	function setLectureCompareB(val) {
		lectureCompareB$1 = val;
		if (typeof window !== "undefined") window.lectureCompareB = val;
	}
	function setTrendsRangeStart(val) {
		trendsRangeStart$1 = val;
		if (typeof window !== "undefined") window.trendsRangeStart = val;
	}
	function setTrendsRangeEnd(val) {
		trendsRangeEnd$1 = val;
		if (typeof window !== "undefined") window.trendsRangeEnd = val;
	}
	function setHistoryStack(val) {
		historyStack$1 = val;
		if (typeof window !== "undefined") window.historyStack = val;
	}
	function setIsNavigatingHistory(val) {
		isNavigatingHistory$1 = val;
		if (typeof window !== "undefined") window.isNavigatingHistory = val;
	}
	function setSuppressHashSync(val) {
		suppressHashSync$1 = val;
		if (typeof window !== "undefined") window.suppressHashSync = val;
	}
	function setExpectedHash(val) {
		expectedHash$1 = val;
		if (typeof window !== "undefined") window.expectedHash = val;
	}
	function setGlobalSearchTimer(val) {
		globalSearchTimer$1 = val;
		if (typeof window !== "undefined") window.globalSearchTimer = val;
	}
	function setGlobalSearchActiveIndex(val) {
		globalSearchActiveIndex$1 = val;
		if (typeof window !== "undefined") window.globalSearchActiveIndex = val;
	}
	function setGlobalSearchScope(val) {
		globalSearchScope$1 = val;
		if (typeof window !== "undefined") window.globalSearchScope = val;
	}
	function syncStateToGlobal() {
		if (typeof window === "undefined") return;
		window.APP_DATA = APP_DATA$1;
		window.currentEntity = currentEntity$1;
		window.currentTab = currentTab$1;
		window.activeFilters = activeFilters$1;
		window.onlyDiscussed = onlyDiscussed$1;
		window.onlyQuestionCandidates = onlyQuestionCandidates$1;
		window.searchQuery = searchQuery$1;
		window.sortMostFrequentFirst = sortMostFrequentFirst$1;
		window.selectedItem = selectedItem$1;
		...
		window.trendsRangeEnd = trendsRangeEnd$1;
		window.currentVizModule = currentVizModule$1;
		window.currentKwicSource = currentKwicSource$1;
		window.currentKwicQuery = currentKwicQuery$1;
		window.currentKwicSort = currentKwicSort$1;
		window.currentKwicPageStart = currentKwicPageStart$1;
		window.currentKwicPageEnd = currentKwicPageEnd$1;
		window.globalSearchScope = globalSearchScope$1;
		window.pendingGlossaryQuery = pendingGlossaryQuery$1;
		window.currentGlossaryTerm = currentGlossaryTerm$1;
		window.pendingScholarAnchor = pendingScholarAnchor$1;
		window.currentScholarAnchor = currentScholarAnchor$1;
		window.currentVizQueryString = currentVizQueryString$1;
		window.pendingKwicTerm = pendingKwicTerm$1;
		window.graphStrongOnly = graphStrongOnly$1;
		window.nameGraphMinEdgeWeight = nameGraphMinEdgeWeight$1;
		window.historyStack = historyStack$1;
		window.isNavigatingHistory = isNavigatingHistory$1;
		window.suppressHashSync = suppressHashSync$1;
		window.expectedHash = expectedHash$1;
		window.globalSearchTimer = globalSearchTimer$1;
		window.globalSearchActiveIndex = globalSearchActiveIndex$1;
	}
	function syncStateFromGlobal() {
		if (typeof window === "undefined") return;
		if (window.currentEntity !== void 0) currentEntity$1 = window.currentEntity;
		if (window.currentTab !== void 0) currentTab$1 = window.currentTab;
		if (window.activeFilters !== void 0) activeFilters$1 = window.activeFilters;
		if (window.onlyDiscussed !== void 0) onlyDiscussed$1 = window.onlyDiscussed;
		if (window.onlyQuestionCandidates !== void 0) onlyQuestionCandidates$1 = window.onlyQuestionCandidates;
		if (window.searchQuery !== void 0) searchQuery$1 = window.searchQuery;
		if (window.sortMostFrequentFirst !== void 0) sortMostFrequentFirst$1 = window.sortMostFrequentFirst;
		if (window.selectedItem !== void 0) selectedItem$1 = window.selectedItem;
		...
		if (window.trendsRangeEnd !== void 0) trendsRangeEnd$1 = window.trendsRangeEnd;
		if (window.currentVizModule !== void 0) currentVizModule$1 = window.currentVizModule;
		if (window.currentKwicSource !== void 0) currentKwicSource$1 = window.currentKwicSource;
		if (window.currentKwicQuery !== void 0) currentKwicQuery$1 = window.currentKwicQuery;
		if (window.currentKwicSort !== void 0) currentKwicSort$1 = window.currentKwicSort;
		if (window.currentKwicPageStart !== void 0) currentKwicPageStart$1 = window.currentKwicPageStart;
		if (window.currentKwicPageEnd !== void 0) currentKwicPageEnd$1 = window.currentKwicPageEnd;
		if (window.globalSearchScope !== void 0) globalSearchScope$1 = window.globalSearchScope;
		if (window.pendingGlossaryQuery !== void 0) pendingGlossaryQuery$1 = window.pendingGlossaryQuery;
		if (window.currentGlossaryTerm !== void 0) currentGlossaryTerm$1 = window.currentGlossaryTerm;
		if (window.pendingScholarAnchor !== void 0) pendingScholarAnchor$1 = window.pendingScholarAnchor;
		if (window.currentScholarAnchor !== void 0) currentScholarAnchor$1 = window.currentScholarAnchor;
		if (window.currentVizQueryString !== void 0) currentVizQueryString$1 = window.currentVizQueryString;
		if (window.pendingKwicTerm !== void 0) pendingKwicTerm$1 = window.pendingKwicTerm;
		if (window.graphStrongOnly !== void 0) graphStrongOnly$1 = window.graphStrongOnly;
		if (window.nameGraphMinEdgeWeight !== void 0) nameGraphMinEdgeWeight$1 = window.nameGraphMinEdgeWeight;
		if (window.historyStack !== void 0) historyStack$1 = window.historyStack;
		if (window.isNavigatingHistory !== void 0) isNavigatingHistory$1 = window.isNavigatingHistory;
		if (window.suppressHashSync !== void 0) suppressHashSync$1 = window.suppressHashSync;
		if (window.expectedHash !== void 0) expectedHash$1 = window.expectedHash;
		if (window.globalSearchTimer !== void 0) globalSearchTimer$1 = window.globalSearchTimer;
		if (window.globalSearchActiveIndex !== void 0) globalSearchActiveIndex$1 = window.globalSearchActiveIndex;
	}
	if (typeof window !== "undefined") {
		window.APP_DATA = APP_DATA$1;
		window.LABELS = LABELS$1;
		window.COLORS = COLORS$1;
		window.EPOCH_LABELS = EPOCH_LABELS$1;
		window.EPOCH_COLORS = EPOCH_COLORS$1;
		window.FAMILY_COLORS = FAMILY_COLORS$1;
		window.ENTITY_TYPES = ENTITY_TYPES$1;
		window.currentEntity = currentEntity$1;
		window.currentTab = currentTab$1;
		window.activeFilters = activeFilters$1;
		window.onlyDiscussed = onlyDiscussed$1;
		...
		window.currentKwicPageEnd = currentKwicPageEnd$1;
		window.pendingKwicTerm = pendingKwicTerm$1;
		window.normalizeHeadCache = normalizeHeadCache$1;
		window.aggregateCache = aggregateCache$1;
		window.nameGraphLayoutPromiseCache = nameGraphLayoutPromiseCache$1;
		window.familiesGraphLayoutPromiseCache = familiesGraphLayoutPromiseCache$1;
		window.ITEM_INDEX_EXACT = ITEM_INDEX_EXACT$1;
		window.ITEM_INDEX_NORMALIZED = ITEM_INDEX_NORMALIZED$1;
		window.CHAPTER_ITEM_INDEX = CHAPTER_ITEM_INDEX$1;
		window.ITEM_HASH_SLUG_BY_HEAD = ITEM_HASH_SLUG_BY_HEAD$1;
		window.ITEM_HASH_HEAD_BY_SLUG = ITEM_HASH_HEAD_BY_SLUG$1;
		window.PAGE_TO_CHAPTER = PAGE_TO_CHAPTER$1;
	}
	//#endregion
	//#region src/runtime/core/utils.js
	var utils_exports = /* @__PURE__ */ __exportAll({
		ACCENT_SAFE_TOKEN_RE: () => ACCENT_SAFE_TOKEN_RE$1,
		CYRILLIC_TO_LATIN_MAP: () => CYRILLIC_TO_LATIN_MAP$1,
		announceUiMessage: () => announceUiMessage$1,
		buildHashSlugIndexesForItems: () => buildHashSlugIndexesForItems$1,
		clampPageInBook: () => clampPageInBook$1,
		clampUiInput: () => clampUiInput$1,
		compareHeadsRu: () => compareHeadsRu$1,
		compareItemsByHead: () => compareItemsByHead$1,
		deterministicUnitFromString: () => deterministicUnitFromString$1,
		encodeItemHeadForHash: () => encodeItemHeadForHash$1,
		escapeHtml: () => escapeHtml$1,
		escapeMarkdownTableCell: () => escapeMarkdownTableCell$1,
		escapeYamlDoubleQuoted: () => escapeYamlDoubleQuoted$1,
		getCachedAggregate: () => getCachedAggregate$1,
		getDataSignature: () => getDataSignature$1,
		getIndexedItem: () => getIndexedItem$1,
		getTotalBookPages: () => getTotalBookPages$1,
		invalidateAggregateCache: () => invalidateAggregateCache$1,
		normalizeBibtexText: () => normalizeBibtexText$1,
		normalizeHashSlug: () => normalizeHashSlug$1,
		normalizeHeadForMatch: () => normalizeHeadForMatch$1,
		normalizeKwicSort: () => normalizeKwicSort$1,
		normalizeKwicSource: () => normalizeKwicSource$1,
		normalizePageRangeInBook: () => normalizePageRangeInBook$1,
		nowMs: () => nowMs$1,
		perfDebug: () => perfDebug$1,
		rememberBoundedCacheValue: () => rememberBoundedCacheValue$1,
		resolveExistingHead: () => resolveExistingHead$1,
		resolveItemHeadFromHash: () => resolveItemHeadFromHash$1,
		safeSetAttr: () => safeSetAttr$1,
		shuffleArray: () => shuffleArray$1,
		slugify: () => slugify$1
	});
	var ACCENT_SAFE_TOKEN_RE$1 = /([^\s,;()[\]{}<>]*[\u0300-\u036f][^\s,;()[\]{}<>]*)/g;
	var CYRILLIC_TO_LATIN_MAP$1 = Object.freeze({
		"а": "a",
		"б": "b",
		"в": "v",
		"г": "g",
	...
	function safeSetAttr$1(el, name, value) {
		if (!el || typeof el.setAttribute !== "function") return;
		el.setAttribute(name, value);
	}
	function perfDebug$1(label, ms, meta = "") {
		if (typeof console === "undefined" || typeof console.debug !== "function") return;
		const extra = meta ? ` · ${meta}` : "";
		console.debug(`[perf] ${label}: ${ms.toFixed(1)}ms${extra}`);
	}
	function deterministicUnitFromString$1(text, salt = 0) {
	...
	function getDataSignature$1() {
		if (!APP_DATA$1) return "none";
		return [
			(APP_DATA$1.names || []).length,
			(APP_DATA$1.toponyms || []).length,
			(APP_DATA$1.ethnonyms || []).length,
			(APP_DATA$1.languages || []).length,
			(APP_DATA$1.lexicon || []).length,
			(APP_DATA$1.lexicon_reverse || []).length,
			(APP_DATA$1.lexicon_tech || []).length,
			(APP_DATA$1.edges || []).length,
			(APP_DATA$1.language_edges || []).length,
			(APP_DATA$1.chapters || []).length
		].join("-");
	}
	function rememberBoundedCacheValue$1(cache, key, value, maxSize, options = {}) {
	...
	function getCachedAggregate$1(kind, key, computeFn) {
		const fullKey = `${kind}::${key}`;
		if (aggregateCache$1.has(fullKey)) {
			perfDebug$1(`${kind} cache`, 0, "hit");
			return aggregateCache$1.get(fullKey);
		}
		const t0 = nowMs$1();
		const value = computeFn();
		const dt = nowMs$1() - t0;
		rememberBoundedCacheValue$1(aggregateCache$1, fullKey, value, 100);
		perfDebug$1(`${kind} cache`, dt, "miss");
		return value;
	}
	function invalidateAggregateCache$1(reason = "") {
		const hadAny = aggregateCache$1.size > 0 || nameGraphLayoutPromiseCache$1.size > 0 || familiesGraphLayoutPromiseCache$1.size > 0;
		aggregateCache$1.clear();
		nameGraphLayoutPromiseCache$1.clear();
		familiesGraphLayoutPromiseCache$1.clear();
		if (hadAny) perfDebug$1("aggregate cache reset", 0, reason || "clear");
	}
	...
	function escapeYamlDoubleQuoted$1(value) {
		return normalizeBibtexText$1(value).replace(/\\/g, "\\\\").replace(/"/g, "\\\"").replace(/\r/g, "\\r").replace(/\n/g, "\\n").replace(/\t/g, "\\t");
	}
	function escapeMarkdownTableCell$1(value) {
		return String(value || "").replace(/\\/g, "\\\\").replace(/\|/g, "\\|").replace(/\r?\n/g, " ");
	}
	function clampUiInput$1(value, maxLen) {
		const limit = Number.isFinite(maxLen) && maxLen > 0 ? maxLen : 80;
		return String(value || "").trim().slice(0, limit);
	}
	function getTotalBookPages$1() {
	...
	function normalizeKwicSort$1(mode) {
		return [
			...
			"right",
			"page"
		].includes(mode) ? mode : "left";
	}
	function clampPageInBook$1(value) {
		const total = getTotalBookPages$1();
		const raw = Number.isFinite(value) ? value : parseInt(String(value || ""), 10);
		if (!Number.isFinite(raw)) return 1;
		return Math.max(1, Math.min(total, raw));
	}
	function normalizePageRangeInBook$1(startValue, endValue, fallbackStart = 1, fallbackEnd = null) {
		const resolvedFallbackEnd = fallbackEnd == null ? getTotalBookPages$1() : fallbackEnd;
		const start = startValue == null ? clampPageInBook$1(fallbackStart) : clampPageInBook$1(startValue);
		const end = endValue == null ? clampPageInBook$1(resolvedFallbackEnd) : clampPageInBook$1(endValue);
		return start <= end ? {
			start,
			end
		} : {
	...
	function announceUiMessage$1(message) {
		...
		if (!live) {
			...
			safeSetAttr$1(live, "aria-live", "polite");
			safeSetAttr$1(live, "aria-atomic", "true");
	...
	function normalizeHeadForMatch$1(value) {
		if (value === null || value === void 0) return "";
		const raw = String(value);
		const cached = normalizeHeadCache$1.get(raw);
		...
		rememberBoundedCacheValue$1(normalizeHeadCache$1, raw, s, NORMALIZE_CACHE_LIMIT$1, { clearWhenFull: true });
		return s;
	}
	function compareHeadsRu$1(aHead, bHead) {
		const aRaw = String(aHead || "");
		const bRaw = String(bHead || "");
		const aNorm = normalizeHeadForMatch$1(aRaw);
		const bNorm = normalizeHeadForMatch$1(bRaw);
		const primary = aNorm.localeCompare(bNorm, "ru", {
			sensitivity: "base",
			numeric: true
		});
		if (primary !== 0) return primary;
		return aRaw.localeCompare(bRaw, "ru", {
			sensitivity: "base",
			numeric: true
		});
	}
	function compareItemsByHead$1(a, b) {
		return compareHeadsRu$1(a?.head, b?.head);
	}
	function slugify$1(text) {
		return String(text || "").toLowerCase().replace(/[^a-zа-яё0-9]+/gi, "-").replace(/^-+|-+$/g, "").slice(0, 80) || "item";
	}
	function normalizeHashSlug$1(value) {
		if (value === null || value === void 0) return "";
		...
		for (const ch of text) {
			...
			if (Object.prototype.hasOwnProperty.call(CYRILLIC_TO_LATIN_MAP$1, ch)) {
				out += CYRILLIC_TO_LATIN_MAP$1[ch];
				continue;
			}
			out += "-";
		}
	...
	function buildHashSlugIndexesForItems$1(items) {
		...
		for (const it of items) {
			...
			const base = normalizeHashSlug$1(head) || "item";
			let slug = base;
			let suffix = 2;
			while (bySlug.has(slug) && bySlug.get(slug) !== head) {
				const suffixToken = `-${suffix}`;
				const keep = Math.max(1, 60 - suffixToken.length);
				slug = `${base.slice(0, keep).replace(/-+$/g, "") || "item"}${suffixToken}`;
				suffix += 1;
			}
	...
	function getIndexedItem$1(type, head) {
		if (!type || !head) return null;
		const exact = ITEM_INDEX_EXACT$1.get(type);
		if (exact && exact.has(head)) return exact.get(head);
		const nHead = normalizeHeadForMatch$1(head);
		const normalized = ITEM_INDEX_NORMALIZED$1.get(type);
		if (nHead && normalized && normalized.has(nHead)) return normalized.get(nHead);
		return null;
	}
	function resolveExistingHead$1(type, head) {
		const item = getIndexedItem$1(type, head);
		return item ? item.head : head;
	}
	function encodeItemHeadForHash$1(type, head) {
		const resolved = resolveExistingHead$1(type, head);
		const byHead = ITEM_HASH_SLUG_BY_HEAD$1.get(type);
		if (byHead && byHead.has(resolved)) return byHead.get(resolved);
		return normalizeHashSlug$1(resolved) || resolved;
	}
	function resolveItemHeadFromHash$1(type, encodedHead) {
		const raw = clampUiInput$1(encodedHead, 120);
		if (!raw) return "";
		const exact = getIndexedItem$1(type, raw);
		if (exact) return exact.head;
		const bySlug = ITEM_HASH_HEAD_BY_SLUG$1.get(type);
		if (bySlug) {
			if (bySlug.has(raw)) return bySlug.get(raw);
			const normalizedSlug = normalizeHashSlug$1(raw);
			if (normalizedSlug && bySlug.has(normalizedSlug)) return bySlug.get(normalizedSlug);
		}
		return resolveExistingHead$1(type, raw);
	}
	...
	if (typeof window !== "undefined") {
		...
		window.perfDebug = perfDebug$1;
		window.deterministicUnitFromString = deterministicUnitFromString$1;
		window.getDataSignature = getDataSignature$1;
		window.getCachedAggregate = getCachedAggregate$1;
		window.invalidateAggregateCache = invalidateAggregateCache$1;
		window.escapeHtml = escapeHtml$1;
		window.escapeYamlDoubleQuoted = escapeYamlDoubleQuoted$1;
		window.escapeMarkdownTableCell = escapeMarkdownTableCell$1;
		window.clampUiInput = clampUiInput$1;
		window.getTotalBookPages = getTotalBookPages$1;
		window.normalizeKwicSource = normalizeKwicSource$1;
		window.normalizeKwicSort = normalizeKwicSort$1;
		window.clampPageInBook = clampPageInBook$1;
		window.normalizePageRangeInBook = normalizePageRangeInBook$1;
		window.announceUiMessage = announceUiMessage$1;
		window.shuffleArray = shuffleArray$1;
		window.normalizeHeadForMatch = normalizeHeadForMatch$1;
		window.compareHeadsRu = compareHeadsRu$1;
		window.compareItemsByHead = compareItemsByHead$1;
		window.slugify = slugify$1;
		window.normalizeHashSlug = normalizeHashSlug$1;
		window.buildHashSlugIndexesForItems = buildHashSlugIndexesForItems$1;
		window.getIndexedItem = getIndexedItem$1;
		window.resolveExistingHead = resolveExistingHead$1;
		window.encodeItemHeadForHash = encodeItemHeadForHash$1;
		window.resolveItemHeadFromHash = resolveItemHeadFromHash$1;
	...
	var data_exports = /* @__PURE__ */ __exportAll({
		DESCRIPTION_FIELDS_WITH_NORMALIZED_YO: () => DESCRIPTION_FIELDS_WITH_NORMALIZED_YO$1,
		LECTURE_WHY_READ_BROTHER_BRAT: () => LECTURE_WHY_READ_BROTHER_BRAT$1,
		TAB_LABELS: () => TAB_LABELS$1,
		appDataModuleUrl: () => appDataModuleUrl$1,
		applyActiveBookFromQuery: () => applyActiveBookFromQuery$1,
		applyDescriptionEditorialConventions: () => applyDescriptionEditorialConventions$1,
		buildAllItems: () => buildAllItems$1,
		buildDataIndexes: () => buildDataIndexes$1,
		buildDefaultCorpusRegistry: () => buildDefaultCorpusRegistry$1,
		fetchAppDataModule: () => fetchAppDataModule$1,
		getActiveBook: () => getActiveBook$1,
		getContextEntries: () => getContextEntries$1,
		getCorpusBooks: () => getCorpusBooks$1,
		getCorpusRegistry: () => getCorpusRegistry$1,
		getEmbeddedAppDataText: () => getEmbeddedAppDataText$1,
		getFirstContextQuote: () => getFirstContextQuote$1,
		hydrateAppData: () => hydrateAppData$1,
		indexItems: () => indexItems$1,
		initEntityTypes: () => initEntityTypes,
		isAppDataModuleManifest: () => isAppDataModuleManifest$1,
		loadAppData: () => loadAppData,
		loadAppDataFromModules: () => loadAppDataFromModules$1,
		migrateAppDataSchema: () => migrateAppDataSchema$1,
		normalizeAppData: () => normalizeAppData,
		normalizeContextSnippet: () => normalizeContextSnippet$1,
		normalizeCorpusRegistry: () => normalizeCorpusRegistry$1,
		normalizeDescriptionYoInNode: () => normalizeDescriptionYoInNode$1,
		normalizeDescriptionYoText: () => normalizeDescriptionYoText$1,
		normalizeEditorialFlags: () => normalizeEditorialFlags$1,
		normalizeItemContexts: () => normalizeItemContexts$1,
		normalizeItemSources: () => normalizeItemSources$1,
		parseAppData: () => parseAppData
	});
	var DESCRIPTION_FIELDS_WITH_NORMALIZED_YO$1 = new Set([
		"desc",
		"about",
		"why",
		"why_read",
	...
	var LECTURE_WHY_READ_BROTHER_BRAT$1 = "Чтобы понять, почему «brother» и «брат» — родственники, а не дети «санскрита», и как это узнают ученые.";
	function getEmbeddedAppDataText$1() {
		if (typeof document !== "undefined" && typeof document.getElementById === "function") {
			const node = document.getElementById(APP_DATA_SCRIPT_TAG_ID$1);
			if (node && typeof node.textContent === "string") {
				const raw = node.textContent.trim();
				if (raw) return raw;
			}
		}
		const fallback = typeof globalThis !== "undefined" && typeof globalThis["__APP_DATA_STRING__"] === "string" ? globalThis[APP_DATA_GLOBAL_FALLBACK_KEY$1] : "";
		return String(fallback || "").trim();
	}
	function hydrateAppData$1(data) {
		setAppData(data);
		if (typeof window !== "undefined") {
			window.__vizCache = {};
			window.VIZ_MODULES = window.VIZ_MODULES || {};
		} else if (typeof globalThis !== "undefined") globalThis.__vizCache = {};
		migrateAppDataSchema$1(data);
	...
	function isAppDataModuleManifest$1(value) {
		return !!(value && typeof value === "object" && !Array.isArray(value) && value.mode === "modules" && Array.isArray(value.modules));
	}
	function appDataModuleUrl$1(manifest, file) {
		const base = String(manifest && manifest.base_url || "./data/modules/");
		const rootUrl = typeof document !== "undefined" && document.baseURI ? document.baseURI : typeof location !== "undefined" && location.href ? location.href : "http://localhost/";
		const url = new URL(String(file || ""), new URL(base, rootUrl));
		const buildId = String(manifest && manifest.build_id || "__APP_BUILD_ID__").trim();
		if (buildId && buildId !== "__APP_BUILD_ID__") url.searchParams.set("v", buildId);
		return url.href;
	}
	async function fetchAppDataModule$1(manifest, file) {
		const url = appDataModuleUrl$1(manifest, file);
		const response = await fetch(url, { cache: "default" });
		if (!response.ok) throw new Error(`Failed to load app data module ${file}: HTTP ${response.status}`);
		const payload = await response.json();
		if (!payload || Array.isArray(payload) || typeof payload !== "object") throw new Error(`App data module must be a JSON object: ${file}`);
		return payload;
	}
	async function loadAppDataFromModules$1(manifest) {
		...
		const payloads = await Promise.all(modules.map((entry) => fetchAppDataModule$1(manifest, entry.file)));
		const merged = {};
		...
		const ordered = {};
		for (const key of keyOrder) if (Object.prototype.hasOwnProperty.call(merged, key)) ordered[key] = merged[key];
		for (const [key, value] of Object.entries(merged)) if (!Object.prototype.hasOwnProperty.call(ordered, key)) ordered[key] = value;
		return ordered;
	}
	function parseAppData() {
		const payload = getEmbeddedAppDataText$1();
		if (!payload) throw new Error("Embedded app data not found");
		const data = JSON.parse(payload);
		if (isAppDataModuleManifest$1(data)) throw new Error("Embedded app data contains a module manifest; use loadAppData() instead");
		return hydrateAppData$1(data);
	}
	async function loadAppData() {
		const payload = getEmbeddedAppDataText$1();
		if (!payload) throw new Error("Embedded app data not found");
		const parsed = JSON.parse(payload);
		return hydrateAppData$1(isAppDataModuleManifest$1(parsed) ? await loadAppDataFromModules$1(parsed) : parsed);
	}
	function migrateAppDataSchema$1(data) {
		...
		if (version > 2 && typeof console !== "undefined" && typeof console.warn === "function") console.warn(`[schema] app_data schema_version ${version} is newer than supported 2`);
	}
	function buildDefaultCorpusRegistry$1() {
		const stats = APP_DATA$1 && APP_DATA$1.book_stats && typeof APP_DATA$1.book_stats === "object" ? APP_DATA$1.book_stats : {};
		return {
			schema_version: 1,
			...
			books: [{
				...
				status: "active",
				source_type: "book",
				pages_total: Number.isFinite(Number(stats.total_pages)) ? Number(stats.total_pages) : 424,
	...
	function getCorpusRegistry$1() {
		if (!APP_DATA$1 || !APP_DATA$1.corpus || typeof APP_DATA$1.corpus !== "object") return buildDefaultCorpusRegistry$1();
		return APP_DATA$1.corpus;
	}
	function getCorpusBooks$1() {
		const books = getCorpusRegistry$1().books;
		return Array.isArray(books) ? books.filter((book) => book && typeof book.book_id === "string") : [];
	}
	function getActiveBook$1() {
		const registry = getCorpusRegistry$1();
		const books = getCorpusBooks$1();
		return books.find((book) => book.book_id === registry.active_book_id) || books[0] || buildDefaultCorpusRegistry$1().books[0];
	}
	function applyActiveBookFromQuery$1(query) {
		...
		if (!bookId) return;
		const registry = getCorpusRegistry$1();
		if (!getCorpusBooks$1().some((book) => book.book_id === bookId)) return;
		registry.active_book_id = bookId;
		if (typeof window !== "undefined") window.localStorage.setItem("Zalizniakiada.corpus.activeBook", bookId);
	}
	function normalizeCorpusRegistry$1() {
		if (!APP_DATA$1 || typeof APP_DATA$1 !== "object") return;
		const defaults = buildDefaultCorpusRegistry$1();
		const raw = APP_DATA$1.corpus && typeof APP_DATA$1.corpus === "object" ? APP_DATA$1.corpus : {};
		...
		const activeId = typeof APP_DATA$1.corpus.active_book_id === "string" ? APP_DATA$1.corpus.active_book_id : "";
		if (!books.some((book) => book && book.book_id === activeId)) APP_DATA$1.corpus.active_book_id = defaults.active_book_id;
		if (typeof window !== "undefined" && typeof window.inflateOccurrences === "function") window.inflateOccurrences(APP_DATA$1.corpus.active_book_id);
	}
	function normalizeAppData() {
		if (!APP_DATA$1) return;
		APP_DATA$1.labels = APP_DATA$1.labels || {};
		APP_DATA$1.colors = APP_DATA$1.colors || {};
		normalizeCorpusRegistry$1();
		APP_DATA$1.labels.literator = "Носитель языка";
		APP_DATA$1.labels.schoolchild = "Участник лекции";
		APP_DATA$1.labels.lecture_host = "Участник лекции";
		APP_DATA$1.labels.participant = APP_DATA$1.labels.participant || APP_DATA$1.labels.schoolchild || APP_DATA$1.labels.lecture_host || "Участник лекции";
		APP_DATA$1.colors.participant = APP_DATA$1.colors.participant || APP_DATA$1.colors.schoolchild || APP_DATA$1.colors.lecture_host || "#16a085";
		const names = Array.isArray(APP_DATA$1.names) ? APP_DATA$1.names : [];
		for (const n of names) if (n.subcategory === "schoolchild" || n.subcategory === "lecture_host") n.subcategory = "participant";
		for (const key of [
			"names",
			"toponyms",
			"ethnonyms",
			...
			const arr = Array.isArray(APP_DATA$1[key]) ? APP_DATA$1[key] : [];
			for (const item of arr) {
				normalizeEditorialFlags$1(item);
				normalizeItemSources$1(item);
				normalizeItemContexts$1(item);
			}
		}
		const stats = APP_DATA$1.book_stats || (APP_DATA$1.book_stats = {});
		if (Array.isArray(APP_DATA$1.lectures) && stats.lectures == null) stats.lectures = APP_DATA$1.lectures.length;
		if (stats.has_preface == null) stats.has_preface = ((APP_DATA$1.lectures || [])[0]?.name || "").toLowerCase().includes("предислов");
		...
		if (!stats.top_name || currentTop && currentTop.is_moderator) {
			const topNonModerator = [...names].filter((n) => !n.is_moderator).sort((a, b) => (b.page_list || []).length - (a.page_list || []).length)[0];
			if (topNonModerator) stats.top_name = {
				head: topNonModerator.head,
				count: (topNonModerator.page_list || []).length
			};
		}
		APP_DATA$1.routes = Array.isArray(APP_DATA$1.routes) ? APP_DATA$1.routes : [];
		APP_DATA$1.further_reading = Array.isArray(APP_DATA$1.further_reading) ? APP_DATA$1.further_reading : [];
		APP_DATA$1.featured_quote = APP_DATA$1.featured_quote || {
			text: "",
			page: "",
			lecture: ""
		};
		const scholar = APP_DATA$1.scholar || (APP_DATA$1.scholar = {});
		...
		applyDescriptionEditorialConventions$1();
	}
	function normalizeEditorialFlags$1(item) {
		if (!item || typeof item !== "object") return;
		const raw = item.editorial_flags && typeof item.editorial_flags === "object" ? item.editorial_flags : {};
		const suspectByLegacy = String(item.head || "").trim().startsWith("?") || item.needs_review === true;
		const flags = {
		...
		const note = typeof raw.note === "string" && raw.note.trim() ? raw.note.trim() : typeof item.note === "string" && item.note.trim() ? item.note.trim() : "";
		if (note) flags.note = note;
		item.editorial_flags = flags;
	}
	function getFirstContextQuote$1(item) {
		const entries = getContextEntries$1(item, 1, 5e3);
	...
	function normalizeItemSources$1(item) {
		if (!item || typeof item !== "object") return;
	...
	function normalizeItemContexts$1(item) {
		...
		if (Array.isArray(src)) {
			item.contexts = src.map(normalizeContextSnippet$1).filter(Boolean);
			return;
		}
		const normalized = {};
		for (const [pageRaw, snippets] of Object.entries(src)) {
			const page = parseInt(String(pageRaw || ""), 10);
			if (!Number.isFinite(page) || page < 1 || page > 5e3) continue;
			if (!Array.isArray(snippets)) continue;
			const out = [];
			for (const raw of snippets) {
				const snippet = normalizeContextSnippet$1(raw);
				if (!snippet) continue;
				out.push(snippet);
	...
	function getContextEntries$1(itemOrContexts, pageStart = 1, pageEnd = 5e3, explicitPageList = null) {
		const source = itemOrContexts && typeof itemOrContexts === "object" && Object.prototype.hasOwnProperty.call(itemOrContexts, "contexts") ? itemOrContexts.contexts : itemOrContexts;
		const pageSource = Array.isArray(explicitPageList) ? explicitPageList : itemOrContexts && Array.isArray(itemOrContexts.page_list) ? itemOrContexts.page_list : [];
		if (Array.isArray(source)) {
			...
			const pages = pageSource.map((page) => parseInt(String(page || ""), 10)).filter((page) => Number.isFinite(page) && page >= 1);
			const page = pages.find((candidate) => candidate >= pageStart && candidate <= pageEnd);
			if (pages.length && !page) return [];
			return [{
				page: page || Math.max(1, pageStart),
				snippets
			}];
		}
		...
		for (const [pageRaw, snippets] of Object.entries(safe)) {
			...
			for (const raw of snippets) {
				...
				if (normalizedSnippets.length >= 24) break;
			}
	...
	function normalizeDescriptionYoText$1(value) {
		return String(value == null ? "" : value).replace(/е\u0308/g, "е").replace(/Е\u0308/g, "Е").replace(/ё/g, "е").replace(/Ё/g, "Е");
	}
	function normalizeDescriptionYoInNode$1(node) {
		if (!node || typeof node !== "object") return;
		if (Array.isArray(node)) {
			for (const item of node) normalizeDescriptionYoInNode$1(item);
			return;
		}
		for (const [key, value] of Object.entries(node)) {
			if (typeof value === "string" && DESCRIPTION_FIELDS_WITH_NORMALIZED_YO$1.has(key)) {
				node[key] = normalizeDescriptionYoText$1(value);
				continue;
			}
			if (value && typeof value === "object") normalizeDescriptionYoInNode$1(value);
		}
	}
	function applyDescriptionEditorialConventions$1() {
		normalizeDescriptionYoInNode$1(APP_DATA$1);
		const lectures = Array.isArray(APP_DATA$1?.lectures) ? APP_DATA$1.lectures : [];
		if (lectures[2] && typeof lectures[2].why_read === "string" && lectures[2].why_read.includes("brother") && lectures[2].why_read.includes("брат")) lectures[2].why_read = LECTURE_WHY_READ_BROTHER_BRAT$1;
	}
	function initEntityTypes() {
		setEntityTypes({
			...
			names: {
				title: "Имена",
				items: APP_DATA$1.names,
				edges: APP_DATA$1.edges,
				tabs: [
					"list",
					"cards",
					"histogram",
			...
			lexicon: {
				title: "Лексика",
				items: APP_DATA$1.lexicon,
				tabs: ["list", "histogram"]
			},
			lexicon_reverse: {
				title: "Лексика (обратная)",
				items: APP_DATA$1.lexicon_reverse,
				tabs: ["list"]
			},
			lexicon_tech: {
				title: "Реконструкции",
				items: APP_DATA$1.lexicon_tech,
				tabs: ["list"]
			},
			subject: {
				title: "Предметный",
				items: APP_DATA$1.subject_index || [],
				tabs: [
					"list",
					"histogram",
					"heatmap"
		...
		ENTITY_TYPES$1.all.items = buildAllItems$1();
		for (const key of Object.keys(ENTITY_TYPES$1)) indexItems$1(ENTITY_TYPES$1[key].items);
		buildDataIndexes$1();
		invalidateAggregateCache$1("entity-types-init");
	}
	var TAB_LABELS$1 = {
		viz: "Визуализации",
		list: "Список",
	...
	function buildAllItems$1() {
		const all = [];
		function add(items, type, typeLabel) {
			for (const it of items) all.push({
				...it,
				_entityType: type,
				_entityLabel: typeLabel
			});
		}
		add(APP_DATA$1.names, "names", "имя");
		add(APP_DATA$1.toponyms, "toponyms", "топоним");
		add(APP_DATA$1.ethnonyms, "ethnonyms", "этноним");
		add(APP_DATA$1.languages, "languages", "язык");
		add(APP_DATA$1.lexicon, "lexicon", "лексема");
		add(APP_DATA$1.lexicon_tech, "lexicon_tech", "реконструкция");
		add(APP_DATA$1.lexicon_reverse, "lexicon_reverse", "лексема (обр.)");
		add(APP_DATA$1.subject_index || [], "subject", "понятие");
		return all;
	}
	function indexItems$1(items) {
		if (!items) return;
		for (const it of items) if (!it._search) {
			const raw = String(it.head || "");
			it._search = raw.toLowerCase();
			it._searchNorm = normalizeHeadForMatch$1(raw);
		}
	}
	function buildDataIndexes$1() {
		const exactIndexes = /* @__PURE__ */ new Map();
		const normalizedIndexes = /* @__PURE__ */ new Map();
		const chapterIndexes = /* @__PURE__ */ new Map();
		const slugIndexesByHead = /* @__PURE__ */ new Map();
		const slugIndexesBySlug = /* @__PURE__ */ new Map();
		const pageToChapterMap = /* @__PURE__ */ new Map();
		const chapters = Array.isArray(APP_DATA$1?.chapters) ? APP_DATA$1.chapters : [];
		const localPageToChapter = /* @__PURE__ */ new Map();
		for (const ch of chapters) for (let p = ch.start; p <= ch.end; p++) {
			localPageToChapter.set(p, ch.name);
			pageToChapterMap.set(p, ch);
		}
		for (const [type, conf] of Object.entries(ENTITY_TYPES$1 || {})) {
			...
			for (const it of conf.items) {
				...
				const nHead = normalizeHeadForMatch$1(it.head);
			...
			const slugIndexes = buildHashSlugIndexesForItems$1(conf.items);
	...
	if (typeof window !== "undefined") {
		window.DESCRIPTION_FIELDS_WITH_NORMALIZED_YO = DESCRIPTION_FIELDS_WITH_NORMALIZED_YO$1;
		window.LECTURE_WHY_READ_BROTHER_BRAT = LECTURE_WHY_READ_BROTHER_BRAT$1;
		window.getEmbeddedAppDataText = getEmbeddedAppDataText$1;
		window.hydrateAppData = hydrateAppData$1;
		window.isAppDataModuleManifest = isAppDataModuleManifest$1;
		window.appDataModuleUrl = appDataModuleUrl$1;
		window.fetchAppDataModule = fetchAppDataModule$1;
		window.loadAppDataFromModules = loadAppDataFromModules$1;
		window.parseAppData = parseAppData;
		window.loadAppData = loadAppData;
		window.migrateAppDataSchema = migrateAppDataSchema$1;
		window.buildDefaultCorpusRegistry = buildDefaultCorpusRegistry$1;
		window.getCorpusRegistry = getCorpusRegistry$1;
		window.getCorpusBooks = getCorpusBooks$1;
		window.getActiveBook = getActiveBook$1;
		window.applyActiveBookFromQuery = applyActiveBookFromQuery$1;
		window.normalizeCorpusRegistry = normalizeCorpusRegistry$1;
		window.normalizeAppData = normalizeAppData;
		window.normalizeEditorialFlags = normalizeEditorialFlags$1;
		window.getFirstContextQuote = getFirstContextQuote$1;
		window.normalizeItemSources = normalizeItemSources$1;
		window.normalizeContextSnippet = normalizeContextSnippet$1;
		window.normalizeItemContexts = normalizeItemContexts$1;
		window.getContextEntries = getContextEntries$1;
		window.normalizeDescriptionYoText = normalizeDescriptionYoText$1;
		window.normalizeDescriptionYoInNode = normalizeDescriptionYoInNode$1;
		window.applyDescriptionEditorialConventions = applyDescriptionEditorialConventions$1;
		window.initEntityTypes = initEntityTypes;
		window.TAB_LABELS = TAB_LABELS$1;
		window.buildAllItems = buildAllItems$1;
		window.indexItems = indexItems$1;
		window.buildDataIndexes = buildDataIndexes$1;
	}
	//#endregion
	//#region src/runtime/core/router.js
	var router_exports = /* @__PURE__ */ __exportAll({
		ROUTE_SEO_METADATA: () => ROUTE_SEO_METADATA,
		applyHash: () => applyHash$1,
		applyViewState: () => applyViewState$1,
		buildCanonicalHash: () => buildCanonicalHash$1,
		buildHashFromState: () => buildHashFromState$1,
		captureViewState: () => captureViewState$1,
		encodeHashPart: () => encodeHashPart$1,
		goBackInApp: () => goBackInApp$1,
		parseHashRoute: () => parseHashRoute$1,
		parsePositiveRouteNumber: () => parsePositiveRouteNumber$1,
		pushHistoryState: () => pushHistoryState$1,
		routeValueAfter: () => routeValueAfter$1,
		routeVizAlias: () => routeVizAlias$1,
		sameViewState: () => sameViewState$1,
		syncNavigationHashOnly: () => syncNavigationHashOnly$1,
		syncNavigationState: () => syncNavigationState$1,
		updateBackButton: () => updateBackButton$1,
		updateSEOMetadata: () => updateSEOMetadata,
		updateStructuredData: () => updateStructuredData
	});
	var ROUTE_SEO_METADATA = {
		"home/home": {
	...
	function updateSEOMetadata(routePath, dynamicTitleSuffix = "") {
		...
		if (canonical) canonical.setAttribute("href", `https://gasyoun.github.io/BookIndex/aaz-index.html#v4/${routePath}`);
	}
	function updateStructuredData(schemaObj) {
		if (typeof document === "undefined") return;
		const script = document.getElementById("schema-seo-dynamic");
		if (!script) return;
		if (schemaObj) script.textContent = JSON.stringify(schemaObj, null, 2);
		else script.textContent = "{}";
	}
	function encodeHashPart$1(value) {
		return encodeURIComponent(String(value));
	}
	function buildCanonicalHash$1(parts) {
		return "#" + ["v4", ...Array.isArray(parts) ? parts : []].map(encodeHashPart$1).join("/");
	}
	function parseHashRoute$1(hash) {
		...
		if (!rawParts.length || rawParts.length > 17) return null;
		const decodedParts = [];
		...
		let parts = decodedParts[0] === "v4" ? decodedParts.slice(1) : decodedParts;
		if (parts[0] === "books" && parts[1]) {
			const bookId = parts[1];
			if (!getCorpusBooks$1().some((book) => book.book_id === bookId)) return null;
			parts = parts.slice(2);
		}
	...
	function routeVizAlias$1(parts) {
	...
	function routeValueAfter$1(parts, marker) {
		const pos = Array.isArray(parts) ? parts.indexOf(marker) : -1;
		return pos >= 0 ? parts[pos + 1] : "";
	}
	function parsePositiveRouteNumber$1(value) {
		const raw = String(value || "");
		return /^\d+$/.test(raw) ? parseInt(raw, 10) : null;
	}
	function buildHashFromState$1() {
		syncStateFromGlobal();
		const parts = [currentEntity$1, currentTab$1];
		if (currentEntity$1 === "materials" && currentTab$1 === "lectures") {
		...
		if (currentEntity$1 === "scholar" && currentTab$1 === "page_trends") {
			const start = clampPageInBook$1(trendsRangeStart$1);
			const end = clampPageInBook$1(trendsRangeEnd$1);
			parts.push("range", String(Math.min(start, end)), String(Math.max(start, end)));
		}
		if (currentEntity$1 === "scholar" && currentTab$1 === "viz" && currentVizModule$1) parts.push("module", String(currentVizModule$1));
		if (currentTab$1 === "list" && searchQuery$1 && !selectedItem$1) parts.push("q", searchQuery$1);
		if (selectedItem$1 && rightPaneMode$1 === "card") {
			const itemType = selectedItemType$1 || currentEntity$1;
			const itemHashHead = encodeItemHeadForHash$1(itemType, selectedItem$1);
			parts.push("item", itemType, itemHashHead);
		}
		const hash = buildCanonicalHash$1(parts);
		if (currentEntity$1 === "scholar" && currentTab$1 === "viz" && currentVizQueryString$1) return `${hash}?${currentVizQueryString$1}`;
		return hash;
	}
	var UI_STATE_SCHEMA_VERSION$1 = 3;
	function normalizeGlobalSearchScope$1(scope) {
		return scope === "corpus" ? "corpus" : "current";
	}
	function captureViewState$1() {
		syncStateFromGlobal();
		const globalSearchInput = typeof document !== "undefined" ? document.getElementById("global-search") : null;
		return {
			version: UI_STATE_SCHEMA_VERSION$1,
			currentEntity: currentEntity$1,
			currentTab: currentTab$1,
			selectedItem: selectedItem$1,
			selectedItemType: selectedItemType$1,
			...
			currentKwicPageStart: currentKwicPageStart$1,
			currentKwicPageEnd: currentKwicPageEnd$1,
			activeFilters: Array.from(activeFilters$1),
			globalSearchQuery: globalSearchInput ? String(globalSearchInput.value || "") : "",
			globalSearchScope: globalSearchScope$1
		};
	}
	function sameViewState$1(a, b) {
		if (!a || !b) return false;
	...
	function applyViewState$1(state) {
		if (!state) return;
		const targetEntity = ENTITY_TYPES$1[state.currentEntity] ? state.currentEntity : "home";
		setCurrentEntity(targetEntity);
		let targetTab = state.currentTab || ENTITY_TYPES$1[targetEntity].tabs[0];
		if (!ENTITY_TYPES$1[targetEntity].tabs.includes(targetTab)) targetTab = ENTITY_TYPES$1[targetEntity].tabs[0];
		...
		setTrendsRangeEnd(Number.isInteger(state.trendsRangeEnd) ? state.trendsRangeEnd : getTotalBookPages$1());
		...
		setCurrentKwicSource(normalizeKwicSource$1(state.currentKwicSource));
		setCurrentKwicQuery(typeof state.currentKwicQuery === "string" ? clampUiInput$1(state.currentKwicQuery, 100) : "");
		setCurrentKwicSort(normalizeKwicSort$1(state.currentKwicSort));
		const kwicRange = normalizePageRangeInBook$1(state.currentKwicPageStart, state.currentKwicPageEnd, 1, getTotalBookPages$1());
		...
		const targetSearchScope = Object.prototype.hasOwnProperty.call(state, "globalSearchScope") ? normalizeGlobalSearchScope$1(state.globalSearchScope) : normalizeGlobalSearchScope$1(globalSearchScope$1);
	...
	function pushHistoryState$1() {
		const snap = captureViewState$1();
		if (sameViewState$1(historyStack$1.length ? historyStack$1[historyStack$1.length - 1] : null, snap)) return;
		historyStack$1.push(snap);
		if (historyStack$1.length > 150) historyStack$1.shift();
		updateBackButton$1();
	}
	function updateBackButton$1() {
		if (typeof document === "undefined") return;
		const btn = document.getElementById("back-btn");
		if (!btn) return;
		btn.hidden = historyStack$1.length <= 1;
	}
	function goBackInApp$1() {
		if (historyStack$1.length < 2) return;
		historyStack$1.pop();
		const prev = historyStack$1[historyStack$1.length - 1];
		if (!prev) return;
		setIsNavigatingHistory(true);
		applyViewState$1(prev);
		setIsNavigatingHistory(false);
	}
	function syncNavigationHashOnly$1() {
		const prev = isNavigatingHistory$1;
		setIsNavigatingHistory(true);
		if (typeof window !== "undefined" && typeof window.syncNavigationState === "function") window.syncNavigationState();
		setIsNavigatingHistory(prev);
	}
	function applyHash$1(hash) {
		if (typeof window !== "undefined" && typeof window.closeGlobalSearchResults === "function") window.closeGlobalSearchResults();
		const parsedRoute = parseHashRoute$1(hash);
		if (!parsedRoute) return false;
		applyActiveBookFromQuery$1(parsedRoute.query);
		const routedParts = routeVizAlias$1(parsedRoute.parts);
		const entity = routedParts[0];
		if (!entity || !ENTITY_TYPES$1[entity]) return false;
		const tabCandidate = routedParts[1] || ENTITY_TYPES$1[entity].tabs[0];
		const tab = ENTITY_TYPES$1[entity].tabs.includes(tabCandidate) ? tabCandidate : ENTITY_TYPES$1[entity].tabs[0];
		...
		if (entity === "materials" && tab === "lectures") {
			...
			if (readingPage !== null) {
				if (typeof window !== "undefined") window.localStorage.setItem("Zalizniakiada.readingPage.v1", String(clampPageInBook$1(readingPage)));
			}
		}
		if (entity === "materials" && tab === "glossary") {
			const termValue = routeValueAfter$1(routedParts, "term");
			if (termValue) {
				setPendingGlossaryQuery(clampUiInput$1(termValue, 100).toLowerCase());
				setCurrentGlossaryTerm(clampUiInput$1(termValue, 100).toLowerCase());
			}
		}
		if (entity === "scholar" && tab === "scholar") {
			const anchorValue = routeValueAfter$1(routedParts, "anchor");
			if (anchorValue) {
		...
		if (entity === "scholar" && tab === "viz") {
			...
			const moduleValue = routeValueAfter$1(routedParts, "module");
			if (moduleValue) setCurrentVizModule(String(moduleValue || "").trim() || currentVizModule$1);
		} else setCurrentVizQueryString("");
		if (entity === "scholar" && tab === "page_trends") {
			const rangePos = routedParts.indexOf("range");
			const rangeStart = parsePositiveRouteNumber$1(routedParts[rangePos + 1]);
			const rangeEnd = parsePositiveRouteNumber$1(routedParts[rangePos + 2]);
			if (rangePos >= 0 && rangeStart !== null && rangeEnd !== null) {
				state.trendsRangeStart = clampPageInBook$1(rangeStart);
				state.trendsRangeEnd = clampPageInBook$1(rangeEnd);
		...
		const queryValue = routeValueAfter$1(routedParts, "q");
		if (tab === "list" && queryValue) state.searchQuery = clampUiInput$1(queryValue, 100);
		if (itemPos >= 0 && routedParts[itemPos + 1] && routedParts[itemPos + 2]) {
			const itemType = ENTITY_TYPES$1[routedParts[itemPos + 1]] ? routedParts[itemPos + 1] : state.currentEntity;
			const resolvedHead = resolveItemHeadFromHash$1(itemType, routedParts[itemPos + 2]);
			state.currentEntity = itemType;
			state.currentTab = "list";
			state.selectedItemType = itemType;
			state.selectedItem = resolvedHead || clampUiInput$1(routedParts[itemPos + 2], 120);
			state.rightPaneMode = "card";
		}
		applyViewState$1(state);
		if (!isNavigatingHistory$1) pushHistoryState$1();
		syncNavigationHashOnly$1();
		...
		if (state.selectedItem) displayTitle = `${state.selectedItem} (детали)`;
			...
			const l = (APP_DATA$1 && Array.isArray(APP_DATA$1.lectures) ? APP_DATA$1.lectures : [])[state.currentLecture];
	...
	function syncNavigationState$1() {
		if (!isNavigatingHistory$1) pushHistoryState$1();
		updateBackButton$1();
		if (suppressHashSync$1) return;
		if (typeof window === "undefined" || !window.location) return;
		const nextHash = buildHashFromState$1();
	...
	if (typeof window !== "undefined") {
		...
		window.encodeHashPart = encodeHashPart$1;
		window.buildCanonicalHash = buildCanonicalHash$1;
		window.parseHashRoute = parseHashRoute$1;
		window.routeVizAlias = routeVizAlias$1;
		window.routeValueAfter = routeValueAfter$1;
		window.parsePositiveRouteNumber = parsePositiveRouteNumber$1;
		window.buildHashFromState = buildHashFromState$1;
		window.captureViewState = captureViewState$1;
		window.sameViewState = sameViewState$1;
		window.applyViewState = applyViewState$1;
		window.pushHistoryState = pushHistoryState$1;
		window.updateBackButton = updateBackButton$1;
		window.goBackInApp = goBackInApp$1;
		window.syncNavigationHashOnly = syncNavigationHashOnly$1;
		window.applyHash = applyHash$1;
		window.syncNavigationState = syncNavigationState$1;
  ...
  `;
    ...
    <div class="home-howto-grid">
      ...
      <p><strong>«Зализнякиада»</strong> — интерактивный указатель к книге А. А. Зализняка «Из жизни слов и языков». Он нужен не для линейного чтения, а для быстрых переходов: от имени, слова, языка, места или темы — к страницам, контекстам и связанным карточкам. Основная ссылка: <a href="${escapeHtml(demoHref)}" class="home-howto-link">${escapeHtml(demoHref)}</a>.</p>
      <p class="home-howto-p">${escapeHtml(corpusSummary)}</p>

      <h3 class="home-howto-h3">Быстрый старт</h3>
      <ol class="home-howto-list">
        <li>Начните с глобального поиска в шапке: попробуйте <a href="${escapeHtml(udarenieAllHash)}" class="home-howto-link" id="home-howto-link-udarenie">ударение</a>, <a href="${escapeHtml(globalBerestaHash)}" class="home-howto-link">берестяные грамоты</a>, <a href="${escapeHtml(globalAvanesovHash)}" class="home-howto-link">Аванесов Р. И.</a> или <a href="${escapeHtml(globalAngliaHash)}" class="home-howto-link">Англия</a>.</li>
        <li>Если нужен не один термин, а явление, откройте <a href="${escapeHtml(subjectListHash)}" class="home-howto-link">предметный указатель</a>: там видно, где тема реально разбирается и сколько страниц она покрывает.</li>
        <li>Для чтения вокруг конкретного фрагмента используйте <a href="${escapeHtml(kwicHash)}" class="home-howto-link">KWIC</a>: он показывает контексты по словам, например по запросу <a href="${escapeHtml(sanskritHash)}" class="home-howto-link">санскрит</a>.</li>
        <li>Для географии и языковых ареалов переходите из списка в карту: <a href="${escapeHtml(toponymsMapHash)}" class="home-howto-link">топонимы</a>, <a href="${escapeHtml(ethnonymsMapHash)}" class="home-howto-link">этнонимы</a>, <a href="${escapeHtml(languagesMapHash)}" class="home-howto-link">языки</a>.</li>
      </ol>

      <h3 class="home-howto-h3">Как читать с указателем</h3>
      <ul class="home-howto-list">
        <li><strong>От страницы к теме.</strong> В карточке смотрите список страниц и контексты: так можно быстро понять, где слово лишь упомянуто, а где обсуждается по существу.</li>
        <li><strong>От темы к соседям.</strong> Из карточек переходите в связанные разделы: имя может вести к школе или источнику, топоним — к карте, язык — к семье и ареалу.</li>
        <li><strong>От вопроса к маршруту.</strong> Если не знаете, какой раздел нужен, используйте «Все»: он ищет одновременно по именам, топонимам, языкам, лексике и предметам.</li>
      </ul>

      <h3 class="home-howto-h3">Основные указатели</h3>
      <p class="home-howto-p">Разделы выглядят как алфавитные списки, но отвечают на разные вопросы: кто упомянут, где происходит действие, какие языки и народы важны, какие слова и явления обсуждаются.</p>

      <h4 class="home-howto-h4">Имена</h4>
      <p class="home-howto-p"><a href="${escapeHtml(namesListHash)}" class="home-howto-link">«Имена»</a> — ученые, авторы и исторические фигуры. Примеры: <a href="${escapeHtml(avanesovItemHash)}" class="home-howto-link">Аванесов Р. И.</a>, <a href="${escapeHtml(avvakumHash)}" class="home-howto-link">Аввакум</a>.</p>

      <h4 class="home-howto-h4">Топонимы</h4>
      <p class="home-howto-p"><a href="${escapeHtml(toponymsListHash)}" class="home-howto-link">«Топонимы»</a> — страны, города и регионы. Пример: <a href="${escapeHtml(angliaItemHash)}" class="home-howto-link">Англия</a> в списке и на <a href="${escapeHtml(toponymsMapHash)}" class="home-howto-link">карте</a>; еще один частый запрос — <a href="${escapeHtml(rossiyaHash)}" class="home-howto-link">Россия</a>.</p>

      <h4 class="home-howto-h4">Этнонимы</h4>
      <p class="home-howto-p"><a href="${escapeHtml(ethnonymsListHash)}" class="home-howto-link">«Этнонимы»</a> собирают названия народов и групп: удобно смотреть, где народ обсуждается как носитель языка, традиции или контактной зоны.</p>

      <h4 class="home-howto-h4">Языки</h4>
      <p class="home-howto-p"><a href="${escapeHtml(languagesListHash)}" class="home-howto-link">«Языки»</a> — языки и языковые группы. Пример: <a href="${escapeHtml(austraItemHash)}" class="home-howto-link">австралийские</a> в списке и на <a href="${escapeHtml(languagesMapHash)}" class="home-howto-link">карте языков</a>.</p>

      <h4 class="home-howto-h4">Лексика</h4>
      <p class="home-howto-p"><a href="${escapeHtml(lexiconListHash)}" class="home-howto-link">«Лексика»</a> — словарный указатель к книге. <a href="${escapeHtml(lexiconReverseHash)}" class="home-howto-link">«Лексика (обратная)»</a> помогает искать по окончанию, корню или модели, а не только по началу слова.</p>
      ...
      <p class="home-howto-p"><a href="${escapeHtml(subjectListHash)}" class="home-howto-link">«Предметный»</a> отвечает не на вопрос «где встречается слово», а на вопрос «где разбирается явление»: <a href="${escapeHtml(akanyeSubjectHash)}" class="home-howto-link">аканье</a>, <a href="${escapeHtml(birchSubjectHash)}" class="home-howto-link">берестяные грамоты</a>, <a href="${escapeHtml(articleSubjectHash)}" class="home-howto-link">артикль</a>, <a href="${escapeHtml(udarenieSubjectHash)}" class="home-howto-link">ударение</a>.</p>

      </div>
      <div class="home-howto-column">
      <h3 class="home-howto-h3">Два вида поиска</h3>
      <p class="home-howto-p"><strong>Глобальный поиск</strong> в шапке страницы ищет по всему корпусу: имя, язык, топоним, термин, лекцию или материал. Примеры: <a href="${escapeHtml(angliaHash)}" class="home-howto-link">Англия</a>, <a href="${escapeHtml(udarenieAllHash)}" class="home-howto-link">ударение</a>, <a href="${escapeHtml(globalLekciiHash)}" class="home-howto-link">лекция</a>.</p>
      <p class="home-howto-p"><strong>Локальный поиск</strong> внутри раздела фильтрует только текущий список. Он удобен, когда вы уже знаете тип сущности: имя, язык, топоним, лексика или предмет.</p>

      <h3 class="home-howto-h3">Карты</h3>
      <p class="home-howto-p">Карты работают в разделах <a href="${escapeHtml(toponymsMapHash)}" class="home-howto-link">«Топонимы»</a>, <a href="${escapeHtml(ethnonymsMapHash)}" class="home-howto-link">«Этнонимы»</a> и <a href="${escapeHtml(languagesMapHash)}" class="home-howto-link">«Языки»</a>. Они полезны, когда книжная тема распределена по регионам, а не по одной статье указателя.</p>
      <ul class="home-howto-list">
        <li><a href="${escapeHtml(angliaHash)}" class="home-howto-link">Англия</a> — пример топонима со списком страниц и географической привязкой.</li>
        <li><a href="${escapeHtml(austraHash)}" class="home-howto-link">австралийские</a> — пример языковой зоны, которую удобнее смотреть вместе с картой.</li>
      </ul>

      <h3 class="home-howto-h3">Как использовать в Obsidian</h3>
      <p class="home-howto-p">«Зализнякиада» хорошо работает как навигационный слой поверх личных заметок: карточки дают страницы, а заметки хранят ваши выводы и связи.</p>
      <ul class="home-howto-list">
      ...
      <h3 class="home-howto-h3">Мини-маршрут на пять минут</h3>
      <ol class="home-howto-list">
        <li>Откройте <a href="${escapeHtml(udarenieSubjectHash)}" class="home-howto-link">ударение</a> в предметном указателе и посмотрите страницы.</li>
        <li>Сравните с глобальным поиском по слову <a href="${escapeHtml(udarenieAllHash)}" class="home-howto-link">ударение</a>: так видно разницу между темой и словоупотреблением.</li>
        <li>Перейдите к <a href="${escapeHtml(angliaHash)}" class="home-howto-link">Англии</a> в топонимах и откройте карту.</li>
        <li>Затем откройте <a href="${escapeHtml(languagesListHash)}" class="home-howto-link">языки</a> и свяжите материал с другими карточками или заметками.</li>
      </ol>

      <h3 class="home-howto-h3">Офлайн</h3>
      <p class="home-howto-p">Сайт можно открыть по ссылке или сохранить локально. Файл <code>aaz-index.html</code> автономен: списки, поиск, карточки и переходы между разделами работают без интернета; сеть может понадобиться только внешним тайлам карты.</p>

      <p class="home-howto-p">Главный принцип простой: ищите не только слово, но и тип вопроса. Имя ведет к людям, топоним — к пространству, язык — к ареалу, предметный указатель — к объяснению явления.</p>
      </div>
    </div>
  </details>`;
	}
	...
	function renderPhoneticLawsPanel(container) {
		...
		const currentRoot = simData[currentSimRootIndex$1];
		...
		<div class="sim-container">
			...
			<div class="sim-intro">
				Посмотрите в хронологическом разрезе, как праславянские реконструированные корни эволюционировали в современные славянские языки под воздействием фонетических законов, описанных Зализняком.
			</div>
		...
		for (let i = 0; i < simData.length; i++) {
			simHtml += `<option value="${i}"${i === currentSimRootIndex$1 ? ' selected' : ''}>${escapeHtml(simData[i].root)}</option>`;
		}
		simHtml += `
				</select>
				<button id="sim-btn-prev" class="sim-btn" ${currentSimStep$1 <= 0 ? 'disabled' : ''}>\u2190 Назад</button>
				<button id="sim-btn-next" class="sim-btn" ${currentSimStep$1 >= maxSteps - 1 ? 'disabled' : ''}>Вперед \u2192</button>
				<span class="sim-step-indicator">Шаг: ${currentSimStep$1 + 1} из ${maxSteps}</span>
			</div>
			<div class="sim-grid">`;

		const renderBranch = (title, stepsList) => {
			const activeIndex = Math.min(currentSimStep$1, stepsList.length - 1);
			const stepData = stepsList[activeIndex];
			const isNewlyHighlighted = currentSimStep$1 === activeIndex;
			return `
      ...
      <div class="phonetic-examples">
		...
		if (select) {
			select.onchange = (e) => {
				currentSimRootIndex$1 = parseInt(e.target.value, 10) || 0;
				currentSimStep$1 = 0;
		...
		if (btnNext) {
			btnNext.onclick = () => {
				if (currentSimStep$1 < maxSteps - 1) {
					currentSimStep$1++;
					renderPhoneticLawsPanel(container);
				}
			};
    ...
    <div id="accent-compare-box"></div>
		...
		const currentReconRoot = ACCENT_RECON_DATA[currentAccentReconRootIndex$1];
		const currentReconStage = currentReconRoot.stages[currentAccentReconStageIndex$1];
		...
		for (let i = 0; i < ACCENT_RECON_DATA.length; i++) {
			reconHtml += `<option value="${i}"${i === currentAccentReconRootIndex$1 ? ' selected' : ''}>${escapeHtml(ACCENT_RECON_DATA[i].stem)} (${escapeHtml(ACCENT_RECON_DATA[i].meaning)})</option>`;
		}
		reconHtml += `
					</select>
		...
		for (let i = 0; i < currentReconRoot.stages.length; i++) {
			reconHtml += `<button type="button" class="accent-recon-stage-btn${i === currentAccentReconStageIndex$1 ? ' active' : ''}" data-stage-idx="${i}">${escapeHtml(currentReconRoot.stages[i].name)}</button>`;
		}
		reconHtml += `
					</div>
				</div>
		...
		const hydrated = hydrateToOldRussian(currentOrthoHydratorInput$1);
		...
		<div class="ortho-hydrator-container" id="sch-orthography-hydrator">
			...
			<div class="accent-recon-intro">
				Интерактивный инструмент для автоматической реконструкции древнерусского написания (гидратации) на основе современных слов. Позволяет увидеть, как современные лексемы выглядели бы в новгородских берестяных грамотах и летописях XI-XIV веков.
			</div>
			...
			<div class="ortho-hydrator-grid">
				<div class="ortho-input-area">
					...
					<input type="text" id="ortho-input" class="ortho-input-control" value="${escapeHtml(currentOrthoHydratorInput$1)}" placeholder="Например: хлеб, рука, мясо, день...">
      ...
      <span class="scholar-muted-meta">${escapeHtml((item.page_list || []).length)} стр.</span>
		...
		if (reconSelect) {
			reconSelect.onchange = (e) => {
				currentAccentReconRootIndex$1 = parseInt(e.target.value, 10) || 0;
				if (currentAccentReconStageIndex$1 >= ACCENT_RECON_DATA[currentAccentReconRootIndex$1].stages.length) {
					currentAccentReconStageIndex$1 = 0;
				}
		...
		container.querySelectorAll(".accent-recon-stage-btn[data-stage-idx]").forEach((btn) => {
			btn.onclick = () => {
				currentAccentReconStageIndex$1 = parseInt(btn.dataset.stageIdx, 10) || 0;
				renderScholarPanel(container);
			};
		});
		...
		if (orthoInput) {
			orthoInput.oninput = (e) => {
				currentOrthoHydratorInput$1 = e.target.value;
				const hyd = hydrateToOldRussian(currentOrthoHydratorInput$1);
		...
		container.querySelectorAll(".ortho-preset-btn[data-preset]").forEach((btn) => {
			btn.onclick = () => {
				currentOrthoHydratorInput$1 = btn.dataset.preset;
				renderScholarPanel(container);
	...
	function buildCitationWidgetHtml(type, id) {
    ...
    <div class="citation-widget" id="${containerId}">
      ...
      <div class="citation-box-container">
        <div class="citation-box" id="${containerId}-box" aria-live="polite"></div>
        <button type="button" class="citation-copy-btn" id="${containerId}-copy-btn">Копировать</button>
      </div>
    </div>
  `;
	}
	function wireCitationWidget(container, type, id) {
		const containerId = `citation-widget-${type}-${id || "card"}`;
	...
	if (typeof window !== "undefined") {
		...
		window.appendGlobalSearchSourceGroup = appendGlobalSearchSourceGroup;
		window.appendItemsWithLetters = appendItemsWithLetters;
		window.appendListItemContent = appendListItemContent;
		window.appendListRow = appendListRow;
		...
		window.buildCorpusQualityMetrics = buildCorpusQualityMetrics;
		window.buildCorpusQualityState = buildCorpusQualityState;
		window.buildCorpusVizHash = buildCorpusVizHash;
		window.buildDynamicTasks = buildDynamicTasks;
		window.buildGlobalSearchFuseRecords = buildGlobalSearchFuseRecords;
		window.buildGlobalSearchRouteRecords = buildGlobalSearchRouteRecords;
		window.buildGlobalSearchSecondaryForItem = buildGlobalSearchSecondaryForItem;
		window.buildGlossaryTermHash = buildGlossaryTermHash;
		window.buildHistogramIntroText = buildHistogramIntroText;
		window.buildHomeDeclarativeViewModel = buildHomeDeclarativeViewModel;
		window.buildHomeHowToGuideHtml = buildHomeHowToGuideHtml;
		window.buildItemHash = buildItemHash;
		window.buildKwicContextRow = buildKwicContextRow;
		window.buildLectureLengthQuestion = buildLectureLengthQuestion;
		window.buildLecturePageBreakdownHtml = buildLecturePageBreakdownHtml;
		window.buildLecturePageHash = buildLecturePageHash;
		window.buildLectureTermHash = buildLectureTermHash;
		window.buildListRowsWithLetters = buildListRowsWithLetters;
		window.buildListSearchHash = buildListSearchHash;
		window.buildQualityInheritedContextIndex = buildQualityInheritedContextIndex;
		window.buildReadingNowHash = buildReadingNowHash;
		window.buildScholarAnchorHash = buildScholarAnchorHash;
		window.buildSearchSnippet = buildSearchSnippet;
		window.buildSubjectCrosslinks = buildSubjectCrosslinks;
		...
		window.clearStoredTasksProgress = clearStoredTasksProgress;
		window.closeCardView = closeCardView;
		window.closeGlobalSearchResults = closeGlobalSearchResults;
		window.closeMobileSheet = closeMobileSheet;
		window.collectFurtherReadingBibEntries = collectFurtherReadingBibEntries;
		window.collectGlossaryKwicRows = collectGlossaryKwicRows;
		window.collectLexiconContextBundles = collectLexiconContextBundles;
		window.collectLexiconKwicRows = collectLexiconKwicRows;
		window.collectMatchingGlossaryTerms = collectMatchingGlossaryTerms;
		window.collectNameRelationLinks = collectNameRelationLinks;
		window.collectReadingNow = collectReadingNow;
		window.collectScholarBibliographyBibEntries = collectScholarBibliographyBibEntries;
		window.compareCrossBookCandidateRecords = compareCrossBookCandidateRecords;
		window.compareQualityHeads = compareQualityHeads;
		window.compareQualityQueueItems = compareQualityQueueItems;
		window.copyCurrentUrl = copyCurrentUrl;
		window.countItemContexts = countItemContexts;
		window.countItemMentions = countItemMentions;
		window.countItemQualityContextSnippets = countItemQualityContextSnippets;
		window.countMentionsInRange = countMentionsInRange;
		window.countQualityContextSnippets = countQualityContextSnippets;
		window.createCorpusMetric = createCorpusMetric;
		window.createCorpusSourceCard = createCorpusSourceCard;
		window.createEmptyTasksProgress = createEmptyTasksProgress;
		window.createHomeDeclarativeState = createHomeDeclarativeState;
		window.createQualityQueueRecord = createQualityQueueRecord;
		window.disposeFamiliesGraphWorker = disposeFamiliesGraphWorker;
		...
		window.ensureVizModuleLoaded = ensureVizModuleLoaded;
		window.ensureVizStateLoaded = ensureVizStateLoaded;
		window.escapeBibtexValue = escapeBibtexValue;
		window.escapeRegexLiteral = escapeRegexLiteral;
		window.exportCurrentCardMarkdown = exportCurrentCardMarkdown;
		window.exportCurrentSectionMarkdown = exportCurrentSectionMarkdown;
		window.exportWholeSiteMarkdown = exportWholeSiteMarkdown;
		window.filterGlobalSearchMatchesForScope = filterGlobalSearchMatchesForScope;
		window.findItemByHeadAndType = findItemByHeadAndType;
		window.findLectureIndexByName = findLectureIndexByName;
		window.findRelatedGlossaryTerms = findRelatedGlossaryTerms;
		window.findRelatedLexiconItems = findRelatedLexiconItems;
		window.findSnippetMatch = findSnippetMatch;
		window.formatCoveragePercent = formatCoveragePercent;
		window.formatPhoneticCommentText = formatPhoneticCommentText;
		window.formatPhoneticTransitionText = formatPhoneticTransitionText;
		window.formatQualityPercent = formatQualityPercent;
		window.generateCitation = generateCitation;
		window.getActiveNavSection = getActiveNavSection;
		window.getBookLabelForSearch = getBookLabelForSearch;
		window.getCardNavigationState = getCardNavigationState;
		window.getCategoryColorClass = getCategoryColorClass;
		window.getChapterHistogramStats = getChapterHistogramStats;
		window.getChapterIndexedItems = getChapterIndexedItems;
		window.getContextEntityLinkEntries = getContextEntityLinkEntries;
		window.getContextPriorityInfo = getContextPriorityInfo;
		window.getEffectiveQualityContextInfo = getEffectiveQualityContextInfo;
		window.getEntityDisplayLabel = getEntityDisplayLabel;
		window.getEntityItems = getEntityItems;
		window.getFamiliesGraphLayoutAsync = getFamiliesGraphLayoutAsync;
		window.getFamiliesGraphLayoutSync = getFamiliesGraphLayoutSync;
		window.getFamiliesGraphWorker = getFamiliesGraphWorker;
		window.getFamiliesGraphWorkerScript = getFamiliesGraphWorkerScript;
		window.getFirstLetter = getFirstLetter;
		window.getFocusedHistogramItem = getFocusedHistogramItem;
		window.getGlobalSearchMatches = getGlobalSearchMatches;
		window.getGlobalSearchMatchesFuzzy = getGlobalSearchMatchesFuzzy;
		window.getGlobalSearchMatchesLegacy = getGlobalSearchMatchesLegacy;
		window.getGlobalSearchScopeLabel = getGlobalSearchScopeLabel;
		window.getGlobalSearchWrap = getGlobalSearchWrap;
		window.getHeatmapTopItems = getHeatmapTopItems;
		window.getHistogramSubjectLabel = getHistogramSubjectLabel;
		window.getItemByTypeAndHead = getItemByTypeAndHead;
		window.getItemFrequencyScore = getItemFrequencyScore;
		window.getItemQualityBooks = getItemQualityBooks;
		window.getItemQualityOccurrencePages = getItemQualityOccurrencePages;
		window.getItemQualityPages = getItemQualityPages;
		window.getItemsForChapter = getItemsForChapter;
		window.getLastLetter = getLastLetter;
		window.getListColumnCount = getListColumnCount;
		window.getNameGraphLayout = getNameGraphLayout;
		window.getNameGraphLayoutAsync = getNameGraphLayoutAsync;
		window.getNameGraphLayoutSync = getNameGraphLayoutSync;
		window.getNameGraphWorker = getNameGraphWorker;
		window.getNameGraphWorkerScript = getNameGraphWorkerScript;
		window.getNavSectionById = getNavSectionById;
		window.getPlannedVideoCatalogSource = getPlannedVideoCatalogSource;
		window.getPreferredContextSplitIndex = getPreferredContextSplitIndex;
		window.getQualityContextPageKeys = getQualityContextPageKeys;
		window.getQualityCrossBookEntityPriority = getQualityCrossBookEntityPriority;
		window.getQualityEntityLabel = getQualityEntityLabel;
		window.getQualityEntityPriority = getQualityEntityPriority;
		window.getQualityPageVerificationDetails = getQualityPageVerificationDetails;
		window.getReverseEdgesIndex = getReverseEdgesIndex;
		window.getRightContentHost = getRightContentHost;
		window.getRightEdgeSortKey = getRightEdgeSortKey;
		window.getSavedDensityMode = getSavedDensityMode;
		window.getSavedReadingPage = getSavedReadingPage;
		window.getSourceStatusLabel = getSourceStatusLabel;
		window.getSourceSupportLabel = getSourceSupportLabel;
		window.getSourceTypeLabel = getSourceTypeLabel;
		window.getStoredTasksProgress = getStoredTasksProgress;
		window.getSubjectByLexiconIndex = getSubjectByLexiconIndex;
		window.getSubjectCrosslinksLookup = getSubjectCrosslinksLookup;
		window.getTaskStorageId = getTaskStorageId;
		window.getVisibleItemsForCurrentEntity = getVisibleItemsForCurrentEntity;
		window.getVizModuleCatalog = getVizModuleCatalog;
		window.getVizRegistry = getVizRegistry;
		window.glossaryEntryToMarkdown = glossaryEntryToMarkdown;
		window.groupPagesByLecture = groupPagesByLecture;
		window.guessAuthorAndTitle = guessAuthorAndTitle;
		window.hasContextLinkBoundaries = hasContextLinkBoundaries;
		...
		window.invalidateVisibleItemsCache = invalidateVisibleItemsCache;
		window.isContextLinkWordChar = isContextLinkWordChar;
		window.isMobileViewport = isMobileViewport;
		window.itemHasQualitySource = itemHasQualitySource;
		window.itemMatchesFilters = itemMatchesFilters;
		window.itemToMarkdown = itemToMarkdown;
		window.iterateKwicContextEntries = iterateKwicContextEntries;
		window.lectureToMarkdown = lectureToMarkdown;
		window.loadRecentItems = loadRecentItems;
		window.loadVizScriptOnce = loadVizScriptOnce;
		window.mountVizModule = mountVizModule;
		window.moveListSelection = moveListSelection;
		window.navigateCardByDelta = navigateCardByDelta;
		window.navigateTo = navigateTo;
		window.navigateToItem = navigateToItem;
		window.normalizeDensityMode = normalizeDensityMode;
		window.normalizeGlobalSearchScope = normalizeGlobalSearchScope;
		window.normalizeQualityCandidateKey = normalizeQualityCandidateKey;
		window.normalizeQualitySortKey = normalizeQualitySortKey;
		...
		window.pluralPages = pluralPages;
		...
		window.renderCardInRight = renderCardInRight;
		window.renderCardsPanel = renderCardsPanel;
		window.renderChapterHistogramRows = renderChapterHistogramRows;
		window.renderChapterListFilter = renderChapterListFilter;
		window.renderContent = renderContent;
		window.renderContextTextWithLinks = renderContextTextWithLinks;
		window.renderCorpusQualityPanel = renderCorpusQualityPanel;
		window.renderCorpusSourcesPanel = renderCorpusSourcesPanel;
		window.renderEntitySwitcher = renderEntitySwitcher;
		window.renderEpochsPanel = renderEpochsPanel;
		window.renderFamiliesPanel = renderFamiliesPanel;
		window.renderFurtherReadingPanel = renderFurtherReadingPanel;
		window.renderGalleryPanel = renderGalleryPanel;
		window.renderGlobalSearchEmpty = renderGlobalSearchEmpty;
		window.renderGlobalSearchResults = renderGlobalSearchResults;
		window.renderGlossaryPanel = renderGlossaryPanel;
		window.renderGraphPanel = renderGraphPanel;
		window.renderHeatmapPanel = renderHeatmapPanel;
		window.renderHistogramInRight = renderHistogramInRight;
		window.renderHistogramPanel = renderHistogramPanel;
		window.renderHomePanel = renderHomePanel;
		window.renderHomePanelDeclarative = renderHomePanelDeclarative;
		window.renderIndexSectionSummary = renderIndexSectionSummary;
		window.renderKwicPanel = renderKwicPanel;
		window.renderLectureComparePanel = renderLectureComparePanel;
		window.renderLecturePagePanel = renderLecturePagePanel;
		window.renderLecturesPanel = renderLecturesPanel;
		window.renderList = renderList;
		window.renderListPanel = renderListPanel;
		window.renderListProgressive = renderListProgressive;
		window.renderListVirtualized = renderListVirtualized;
		window.renderMapPanel = renderMapPanel;
		window.renderOfflineMap = renderOfflineMap;
		window.renderPageTrendsPanel = renderPageTrendsPanel;
		window.renderPhoneticLawsPanel = renderPhoneticLawsPanel;
		window.renderQualityProgress = renderQualityProgress;
		window.renderQualityQueueItem = renderQualityQueueItem;
		window.renderQualityQueues = renderQualityQueues;
		window.renderRightContent = renderRightContent;
		window.renderRussianEvolutionPanel = renderRussianEvolutionPanel;
		window.renderScholarChronologyPanel = renderScholarChronologyPanel;
		window.renderScholarPanel = renderScholarPanel;
		window.renderTabs = renderTabs;
		window.renderTasksPanel = renderTasksPanel;
		window.renderTextWithPageLinks = renderTextWithPageLinks;
		window.renderTimelinePanel = renderTimelinePanel;
		window.renderTreePanel = renderTreePanel;
		window.renderViewTabs = renderViewTabs;
		window.renderVizPanel = renderVizPanel;
		window.requestFamiliesGraphLayoutFromWorker = requestFamiliesGraphLayoutFromWorker;
		window.requestNameGraphLayoutFromWorker = requestNameGraphLayoutFromWorker;
		...
		window.setGlobalSearchActiveItem = setGlobalSearchActiveItem;
		window.setMobileSheetOpen = setMobileSheetOpen;
		window.setVizHostStatus = setVizHostStatus;
		window.setVizQueryString = setVizQueryString;
		window.shouldIgnoreGlobalHotkeys = shouldIgnoreGlobalHotkeys;
		window.shouldRenderViewTabs = shouldRenderViewTabs;
		window.sortKwicRows = sortKwicRows;
		window.sortUniquePages = sortUniquePages;
		window.stepLecture = stepLecture;
		window.stripHtml = stripHtml;
		window.summarizeQualityPages = summarizeQualityPages;
		window.supportsFamiliesGraphWorker = supportsFamiliesGraphWorker;
		window.supportsNameGraphWorker = supportsNameGraphWorker;
		window.switchEntity = switchEntity;
		window.switchTab = switchTab;
		window.tokenizeNormalizedForGlossary = tokenizeNormalizedForGlossary;
		window.warmupVizCacheInWorker = warmupVizCacheInWorker;
		window.wireGlobalUI = wireGlobalUI;
		window.wireGraphWorkersLifecycle = wireGraphWorkersLifecycle;
		window.wireReadingNowWidget = wireReadingNowWidget;
		window.wireSafeImageFallback = wireSafeImageFallback;
		window.wrapAccentSafeInEscapedText = wrapAccentSafeInEscapedText;
	}
	//#endregion
	//#region src/runtime/entry.js
	var SMOKE_TEST_CONTRACTS = [
		"function safeUrl(url, fallback = '#')",
		"function safeImageUrl(url, fallback = '')",
		"function registerAppServiceWorker()",
		"navigator.serviceWorker.register(swUrl"
	];
	if (typeof window !== "undefined") window.__SMOKE_TEST_CONTRACTS = SMOKE_TEST_CONTRACTS;
	if (typeof window !== "undefined") {
		Object.assign(window, state_exports);
		Object.assign(window, utils_exports);
		Object.assign(window, data_exports);
		Object.assign(window, router_exports);
	} else if (typeof globalThis !== "undefined") {
		Object.assign(globalThis, state_exports);
		Object.assign(globalThis, utils_exports);
		Object.assign(globalThis, data_exports);
		Object.assign(globalThis, router_exports);
	}
	initLegacy();
	if (typeof document !== "undefined") {
		const content = document.getElementById("content");
		if (content) content.innerHTML = "<div class=\"panel-empty-state\">Загрузка указателей…</div>";
	}
	if (typeof window !== "undefined" && typeof window.registerAppServiceWorker === "function") window.registerAppServiceWorker();
	setTimeout(() => {
		(async () => {
			...
			if (typeof window !== "undefined") {
				...
				const restored = applyHash$1(initialHash);
	...
	//#endregion
	exports.SMOKE_TEST_CONTRACTS = SMOKE_TEST_CONTRACTS;
	return exports;
})({});

var BookIndex = (function(exports) {
	...
	var utils_exports = /* @__PURE__ */ __exportAll({
		...
		rememberBoundedCacheValue: () => rememberBoundedCacheValue,
	...
	function getCachedAggregate$1(kind, key, computeFn) {
		...
		const dt = nowMs$1() - t0;
		rememberBoundedCacheValue(aggregateCache$1, fullKey, value, 100);
	...
	function normalizeHeadForMatch$1(value) {
		...
		rememberBoundedCacheValue(normalizeHeadCache$1, raw, s, NORMALIZE_CACHE_LIMIT$1, { clearWhenFull: true });
		return s;
	}
	...
	var router_exports = /* @__PURE__ */ __exportAll({
		...
		encodeHashPart: () => encodeHashPart,
		goBackInApp: () => goBackInApp$1,
		parseHashRoute: () => parseHashRoute$1,
		parsePositiveRouteNumber: () => parsePositiveRouteNumber,
		pushHistoryState: () => pushHistoryState$1,
		routeValueAfter: () => routeValueAfter,
		routeVizAlias: () => routeVizAlias,
		sameViewState: () => sameViewState,
	...
	function buildCanonicalHash$1(parts) {
		return "#" + ["v4", ...Array.isArray(parts) ? parts : []].map(encodeHashPart).join("/");
	}
	...
	function applyViewState$1(state) {
		...
		const targetSearchScope = Object.prototype.hasOwnProperty.call(state, "globalSearchScope") ? normalizeGlobalSearchScope(state.globalSearchScope) : normalizeGlobalSearchScope(globalSearchScope$1);
	...
	function pushHistoryState$1() {
		...
		if (sameViewState(historyStack$1.length ? historyStack$1[historyStack$1.length - 1] : null, snap)) return;
